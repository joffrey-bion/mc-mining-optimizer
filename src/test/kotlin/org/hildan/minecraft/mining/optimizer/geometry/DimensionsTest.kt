...
internal class DimensionsTest {
    ...
    fun positionPlus() {
        with(Dimensions(2, 3, 4)) {
            ...
            assertEquals(pos000, pos010 + ONE_BELOW)
            assertEquals(pos100, pos110 + ONE_BELOW)
            assertEquals(pos001, pos011 + ONE_BELOW)
            assertEquals(pos101, pos111 + ONE_BELOW)

            assertEquals(pos100, pos000 + ONE_EAST)
            assertEquals(pos000, pos100 + ONE_EAST)
            assertEquals(pos110, pos010 + ONE_EAST)
            assertEquals(pos010, pos110 + ONE_EAST)
            assertEquals(pos101, pos001 + ONE_EAST)
            assertEquals(pos001, pos101 + ONE_EAST)
            assertEquals(pos111, pos011 + ONE_EAST)
            assertEquals(pos011, pos111 + ONE_EAST)

            assertEquals(pos000, pos000 + Distance3D.of(2, 0, 0))
            assertEquals(pos020, pos000 + Distance3D.of(0, 2, 0))
            assertEquals(pos003, pos000 + Distance3D.of(0, 0, 3))
        }
    }
